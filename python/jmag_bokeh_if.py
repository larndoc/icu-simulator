...
class Grapher:
    def __init__(self, csv_reader, figure_factory=None, key_groups=None, indep_var='Time'):
        """
        Constructor.
            ...
            indep_var       : the independent variable common to each
                              graph generated by this class. For example,
                              to do time-series and FFTs on one page,
                              two grapher objects would be needed,
                              one with indep_var='Time', and one
                              with indep_var='f'.
        """
        self.active_lines = {}
