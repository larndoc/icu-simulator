...
extern void		ae_open		(void);
extern void		ae_close	(void);
extern double		ae_set		(const char* name, double value);
extern double		ae_eval		(const char* expression);
extern const char*	ae_error	(void);
