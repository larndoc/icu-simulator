...
static const int num_dp[N_DEV] = {4, 4, 6, 25, 1, 27, 16};
...
/* this is mostly used for waveform parsing */
static
const char header_strs[N_DEV][32][32] = {
		/* FIB SCI */
		{"Time", "Bx", "By", "Bz", "Status"},
		/* FOB SCI */
		{"Time", "Bx", "By", "Bz", "Range"},
		/* FSC SCI */
		{"Time", "Sensor_Laser", "Laser_Micro", "Zeeman", "Sci_Data_ID",
			"Sci_Data", "Timestamp"},
		/* FIB HK */
		{"Time", "Status_HB", "Status_LB", "LUP_cnt", "P1V5", "P3V3",
			"P5V", "N5V", "P8V", "P12V",  "P1I5", "P3I3", "P5I",
			"N5I", "P8I", "P12I", "TE", "TS1", "TS2", "Checksum",
			"CMD_exec_cnt", "ICU_err_cnt", "Last_cmd", "Last_err",
			"HK_req_cnt", "sync_count"},
		/* FOB HK */
		{"Time", "FOB"},
		/* FSC HK */
		{"Time", "Peregrine_Lock", "Sensor_Temp_A", "Sensor_Temp_B",
			...
			"Diode_Optical_Power", "P2V4", "P3V3", "P8V", "N8V",
			"P12V", "PCB_Temp_C", "PCB_Temp_D", "PCB_Temp_E",
			"ICU_Checksum", "ICU_Command_Count", "ICU_Sync_Count"},
		/* PCU HK */
		{"Time", "I_FIB", "I_FOB", "I_FSC", "I_P3V3", "I_FIBH", "I_FOBH",
			"I_FSCH", "I_P1V8",  "Temp", "V_P2V4", "V_P3V3",
			"V_P12V", "V_P8V", "V_N8V", "V_P5V", "V_N5V"}
};

/* this array is used to lookup      *
 * what header to write to each file */
static
